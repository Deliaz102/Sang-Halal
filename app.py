...
# =========================
APP_TITLE = "Kamus Halal Farmasi dan Kosmetika"
APP_SUBTITLE = "Menyediakan referensi terminologi halal yang terstandar, sistematis, dan berbasis regulasi dibidang Farmasi dan kosmetika."
